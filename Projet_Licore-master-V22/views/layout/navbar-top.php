  ...
  <div class="container">
    ...
    <ul id="navbar-ul" class="nav navbar-nav">
      <?php
		...
		if (estAccessible('bilan-des-competences')) {
          echo '<li id="navbar-bilan-des-competences"><a href="index.php?action=bilan-des-competences" >Bilan des compétences</a></li>';
        }
