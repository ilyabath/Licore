...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 01 Juillet 2016 à 09:57
...
(4, 'Hae.J', 'Haemi', 'JO', '3Jv5f4vG', 3, NULL),
...
(10, 'Nat.W', 'Natasha', 'WELCH', 'ar64MXt2', 3, NULL),
...
(53, 'Hay.T', 'Hayley', 'TOMLINSON', 'mX8kC8h7', 3, NULL),
...
--
ALTER TABLE `explication`
  MODIFY `idExplication` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `validation`
  MODIFY `idValidation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
